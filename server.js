 ...
 *
 * Agora cria um catálogo inicial do índice do repositório ativo.
 * Ainda NÃO baixa nem indexa conteúdo profundo.
 */
...
async function start() {
  try {
    ...
    app.listen(PORT, () => {
      console.log(`AVDC v2.8 rodando na porta ${PORT}`);
    });
  } catch (error) {
